...
export var SplashScreen = function (props) {
    ...
    var enDescription = (_jsx(_Fragment, { children: _jsxs("div", __assign({ className: 'text-bodylarge font-body text-grey1' }, { children: [_jsx("div", __assign({ className: 'mb-4 text-bodylarge font-body text-grey1' }, { children: "You are about to start the process of donating your data to a research institute (i.e., ASCoR University of Amsterdam) for the benefit of mapping the collective wisdom of online rare disease communities: a Patient-driven algorithm (PIPA project). The data that we ask you to donate will be used for academic research aimed at gaining insights into how parents share their knowledge about FoxP1 on Facebook." })), _jsx("div", __assign({ className: 'mb-4 text-bodylarge font-body text-grey1' }, { children: "We will walk you through this process step by step. During this process, no data will be stored or sent to ASCoR. You have the option to delete specific rows from the data before making your donation. Data will only be donated and stored when you click the \u201CYes, donate\u201D  button on the page displaying your data." })), _jsxs("div", __assign({ className: 'mb-6 text-bodylarge font-body text-grey1' }, { children: ["By clicking the \u201C", _jsx("span", __assign({ className: 'font-bodybold' }, { children: "Yes, donate" })), "\u201D button you:"] })), _jsxs("div", __assign({ className: 'flex flex-col gap-3 mb-6' }, { children: [_jsx(Bullet, { children: _jsx("div", { children: " fully and voluntarily agree to donate your data for this research." }) }), _jsx(Bullet, { children: _jsx("div", { children: " are aware that when your data is used for academic publications, or made publicly available in some other form, this will remain anonymous." }) })] }))] })) }));
