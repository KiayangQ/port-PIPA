    ...
    <>
      <div className='text-bodylarge font-body text-grey1'>
        <div className='mb-4 text-bodylarge font-body text-grey1'>
          You are about to start the process of donating your data to a research institute (i.e., ASCoR University of Amsterdam) for the benefit of mapping the collective wisdom of online rare disease communities: a Patient-driven algorithm (PIPA project). The data that we ask you to donate will be used for academic research aimed at gaining insights into how parents share their knowledge about FoxP1 on Facebook.
        </div>
        <div className='mb-4 text-bodylarge font-body text-grey1'>
          We will walk you through this process step by step. During this process, no data will be stored or sent to ASCoR. You have the option to delete specific rows from the data before making your donation. Data will only be donated and stored when you click the “Yes, donate”  button on the page displaying your data.
        </div>
        <div className='mb-6 text-bodylarge font-body text-grey1'>
          By clicking the “<span className='font-bodybold'>Yes, donate</span>” button you:
        </div>
        <div className='flex flex-col gap-3 mb-6'>
          <Bullet>
            <div> fully and voluntarily agree to donate your data for this research.</div>
          </Bullet>
          <Bullet>
            <div> are aware that when your data is used for academic publications, or made publicly available in some other form, this will remain anonymous.</div>
          </Bullet>
          {/* <Bullet>
