...
export var ConsentForm = function (props) {
    ...
    var _a = prepareCopy(props), description = _a.description, donateQuestion = _a.donateQuestion, donateButton = _a.donateButton;
...
var description = new TextBundle()
    .add('en', 'Please review the data below to decide whether you would like to donate it. Carefully check the data and make necessary adjustments. Scroll down to the bottom of the page and click "yes, donate" to complete the donation. Thank you in advance.')
    .add('nl', 'Bepaal of u de onderstaande gegevens wilt doneren. Bekijk de gegevens zorgvuldig en pas zo nodig aan. Ga naar beneden en klik op "ja, doneren" om de donatie af te ronden. Alvast hartelijk dank.');
